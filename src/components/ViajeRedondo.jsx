...
function ViajeRedondo({ data }) {
    const { date, airline, optionsBag, optionsRestrictions, countBag, isCheckedAdult, isCheckedChild } = data;
    return (
        <div
        ...
        >
            {airline === "av" && (
                <img
                    src={aviancaLogo}
                    className="w-[7rem] absolute top-[8rem] left-[2rem] rotate-[45deg]"
                />
            )}
            {airline === "de" && (
                <img
